...
import com.numhero.client.model.datacargo.invoice.ChangeStatusToOverdueDocumentsRequest;
...
public class CommandChangeStatusToOverdueDocuments extends AbstractAuthenticatedCommand<ChangeStatusToOverdueDocumentsRequest, BulkActionResponse> {

    @Inject
    InvoiceDao dao;

    @Override
    public BulkActionResponse execute(ChangeStatusToOverdueDocumentsRequest changeStatusToPaiedDocumentsRequest) throws Exception {
