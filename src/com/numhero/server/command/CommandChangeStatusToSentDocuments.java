...
import com.numhero.client.model.datacargo.invoice.ChangeStatusToSentDocumentsRequest;
...
public class CommandChangeStatusToSentDocuments extends AbstractAuthenticatedCommand<ChangeStatusToSentDocumentsRequest, BulkActionResponse> {

    @Inject
    InvoiceDao dao;

    @Override
    public BulkActionResponse execute(ChangeStatusToSentDocumentsRequest changeStatusToPaiedDocumentsRequest) throws Exception {
