...
public class XmlEntityParser {
    ...
    public static BasePojoC parseEntityData(InputStream xml) {
...
//                System.out.println(qName + " " + atts.getValue("companyId"));
 ...
 //               System.out.println("attr " + t + "  val " + val);
        ...
        private static BasePojoC createPojoC(String classname) {
            BasePojoC entity;
            try {
                Class<BasePojoC> reqClazz = (Class<BasePojoC>) Class.forName("com.numhero.client.model.pojoc." + classname);
