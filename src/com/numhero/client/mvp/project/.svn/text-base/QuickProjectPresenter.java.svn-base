...
@Singleton
public class QuickProjectPresenter extends BasePresenter {
    ...
    @Inject
    public QuickProjectPresenter(EventManager eventManager, Service<GetProjectRequest, GetProjectResponse> projectGetService, Service<SaveProjectRequest, SaveProjectResponse> projectSaveService,
                ...
                if (getProjectPanel().saveValuesFromUi()) {
                    ...
                    projectSaveService.execute(request, new ServiceCallbackImpl<SaveProjectResponse>() {
                        ...
                        public void onSuccess(SaveProjectResponse response) {
                            Window.alert(Application.getConstants().projectSaved());
                            LocationUtils.redirect("#time");
                        }
                    });
                }
            }
