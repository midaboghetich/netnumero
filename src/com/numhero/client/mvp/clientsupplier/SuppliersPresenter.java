...
@Singleton
public class SuppliersPresenter extends GridPresenter {
    ...
    @Inject
    public SuppliersPresenter(EventManager eventManager,
        ...
        getView().setDetailTitlePanel(Application.getConstants().manageSuppliers());
        ...
        Command deleteSuppliersCommand = new Command() {
            public void execute() {
                deleteSuppliers(table.getSelectedIds());
            }
        };
        ...
        bulkActions.addItem(new MenuItem(Application.getConstants().deleteSuppliers(), deleteSuppliersCommand));
    ...
    private void deleteSuppliers(List<String> ids) {
    ...
    private void refreshFromServer() {
        ...
        clientSupplierListService.execute(request, new ServiceCallbackImpl<ClientSupplierListResponse>() {
            ...
            @Override
            public void onFailure(Throwable th) {
                Window.alert("problem getting client:" + th.toString());
            }
