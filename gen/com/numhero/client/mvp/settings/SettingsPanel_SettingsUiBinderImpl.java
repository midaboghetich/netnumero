...
public class SettingsPanel_SettingsUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.VerticalPanel, com.numhero.client.mvp.settings.SettingsPanel>, com.numhero.client.mvp.settings.SettingsPanel.SettingsUiBinder {
  static SettingsPanelSettingsUiBinderImplGenMessages messages = (SettingsPanelSettingsUiBinderImplGenMessages) GWT.create(SettingsPanelSettingsUiBinderImplGenMessages.class);
  ...
  public com.google.gwt.user.client.ui.VerticalPanel createAndBindUi(final com.numhero.client.mvp.settings.SettingsPanel owner) {
    ...
    com.numhero.client.mvp.settings.SettingsPanel_SettingsUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.numhero.client.mvp.settings.SettingsPanel_SettingsUiBinderImpl_GenBundle) GWT.create(com.numhero.client.mvp.settings.SettingsPanel_SettingsUiBinderImpl_GenBundle.class);
