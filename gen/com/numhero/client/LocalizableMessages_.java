...
public class LocalizableMessages_ implements com.numhero.client.LocalizableMessages {
  ...
  public java.lang.String currentDate(java.util.Date timestamp) {
    return com.google.gwt.i18n.client.DateTimeFormat.getLongDateFormat().format(timestamp) + " " + com.google.gwt.i18n.client.DateTimeFormat.getShortTimeFormat().format(timestamp);
  }
