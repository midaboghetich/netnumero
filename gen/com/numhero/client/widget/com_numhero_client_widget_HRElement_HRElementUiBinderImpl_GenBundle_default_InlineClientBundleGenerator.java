...
public class com_numhero_client_widget_HRElement_HRElementUiBinderImpl_GenBundle_default_InlineClientBundleGenerator implements com.numhero.client.widget.HRElement_HRElementUiBinderImpl_GenBundle {
  ...
  public native ResourcePrototype getResource(String name) /*-{
    switch (name) {
      case 'style': return this.@com.numhero.client.widget.HRElement_HRElementUiBinderImpl_GenBundle::style()();
    }
    return null;
  }-*/;
}
