...
public class UserC_Array_Rank_1_FieldSerializer {
  ...
  public static com.numhero.client.model.pojoc.UserC[] instantiate(com.google.gwt.user.client.rpc.SerializationStreamReader streamReader) throws com.google.gwt.user.client.rpc.SerializationException{
    int rank = streamReader.readInt();
    return new com.numhero.client.model.pojoc.UserC[rank];
  }
