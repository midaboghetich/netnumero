...
public class StandardValidationMessagesImpl_ implements eu.maydu.gwt.validation.client.i18n.StandardValidationMessagesImpl {
  ...
  public java.lang.String min(int minValue,int actualValue) {
    return "Der minimale Wert für dieses Feld ist '" + minValue + "'. Eingegeben wurde '" + actualValue + "'";
  }
  
  public java.lang.String max(double maxValue,double actualValue) {
    return "Der maximale Wert für dieses Feld ist '" + maxValue + "'. Eingegeben wurde '" + actualValue + "'";
  }
  ...
  public java.lang.String length(int minLength,int maxLength,int actualLength) {
    return "muss zwischen '" + minLength + "' und '" + maxLength + "' lang sein. Ist '" + actualLength + "' lang.";
  }
  ...
  public java.lang.String notInRange(double min,double max,double value) {
    return "Der Wert '" + value + "' liegt ausserhalb des Bereichs [" + min + "," + max + "]";
  }
  ...
  public java.lang.String notAValidTimeWithSecondsRequired(java.lang.String parameter) {
    return "'" + parameter + "' ist keine gültige Zeitangabe (Sekunden müssen mit angegeben werden)";
  }
  ...
  public java.lang.String notAValidEmail(java.lang.String givenEmailInput) {
    return "'" + givenEmailInput + "' ist keine gültige Email - Adresse";
  }
  ...
  public java.lang.String notAValidTimeWithoutSeconds(java.lang.String parameter) {
    return "'" + parameter + "' ist keine gültige Zeitangabe (Sekunden dürfen nicht mit angegeben werden)";
  }
  ...
  public java.lang.String notAValidTimeWithSecondsOptionally(java.lang.String parameter) {
    return "'" + parameter + "' ist keine gültige Zeitangabe (Sekunden dürfen mit angegeben werden)";
  }
